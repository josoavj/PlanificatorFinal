...
class ClientDetailsDialog extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>> _loadTraitementsByClient(int clientId) async {
    const sql = '''
      SELECT DISTINCT t.traitement_id, t.contrat_id, tt.typeTraitement as nom, tt.categorieTraitement as type
      FROM Traitement t
